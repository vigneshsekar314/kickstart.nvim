...
if vim.g.neovide then
  ...
  -- Helper function for transparency formatting for neovide editor
...
vim.keymap.set('n', '<leader>pro', function()
  vim.cmd 'e D:/python from C drive/python/FletMVPC1'
end, { desc = 'Open passion project' })

vim.keymap.set('n', '<leader>ink', function()
  vim.cmd 'e G:/My Drive/Obsidian Vault/Obsidian Vault/PARA/Resources/Learn'
end, { desc = 'Go to Obsidian Vault Resource' })
